...
export class CourseService {
  ...
  private defaultCourses: Course[] = [
    { category: { code: '001', name: 'הוראה', iconPath: 'assets/images/teach-1968076_1280.jpg' }, courseCode: 'DEF001', courseName: 'קורס הוראה בסיסי', numberOfLessons: 10, startDate: new Date('2024-09-25'), syllabus: ['מבוא להוראה'], learningMethod: LearningMethod.Zoom, lecturerCode: 'משה', imagePath: '' },
    { category: { code: '002', name: 'יצירה ואומנות', iconPath: 'assets/images/hand-4752642_1280.jpg' }, courseCode: 'DEF002', courseName: 'אמנות למתחילים', numberOfLessons: 5, startDate: new Date('2024-09-15'), syllabus: ['יסודות האמנות'], learningMethod: LearningMethod["In-Person"], lecturerCode: 'משה', imagePath: '' },
    { category: { code: '003', name: 'מחשבים', iconPath: 'assets/images/pexels-pixabay-38568.jpg' }, courseCode: 'DEF003', courseName: 'מבוא למדעי המחשב', numberOfLessons: 12, startDate: new Date('2024-10-30'), syllabus: ['תכנות בסיסי'], learningMethod: LearningMethod.Zoom, lecturerCode: 'משה', imagePath: '' },
    { category: { code: '004', name: 'רפואה', iconPath: 'assets/images/syringes-3539565_1280.jpg' }, courseCode: 'DEF004', courseName: 'מבוא לרפואה', numberOfLessons: 8, startDate: new Date('2024-09-30'), syllabus: ['יסודות הרפואה'], learningMethod: LearningMethod["In-Person"], lecturerCode: 'משה', imagePath: '' },
  ];
