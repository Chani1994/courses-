...
//                           });
//                       } else {
//                           // במקרה של משתמש שלא נמצא, העבר לקומפוננטת ההרשמה
...
//                   confirmButtonText: 'אוקי'
//               });
//           } else if (error.status === 404 || error.message === 'User not found') {
//               // במקרה של שגיאה 404 או הודעת "User not found", העבר לקומפוננטת ההרשמה
//               Swal.fire({
//                   icon: 'info',
//                   title: 'משתמש לא נמצא',
//                   text: 'מעבר לרישום...',
